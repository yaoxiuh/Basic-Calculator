...
public class Calculator extends JPanel {
	...
	private JPanel setupNumberPad() {
		...
		final int num3 = 3;
		final int num6 = 6;
		JPanel numberPanel = new JPanel(new GridLayout(num4, num3));
		layoutNumberRange(numberPanel, num7, num9);
		layoutNumberRange(numberPanel, num4, num6);
		layoutNumberRange(numberPanel, 1, num3);
	...
	private JPanel setupOperators() {
		final int num3 = 3;
		JPanel operatorPanel = new JPanel(new GridLayout(0, num3));
	...
	private void numberPressed(int number) {
		final int num10 = 10;
		if(this.enteringNumber) {
			this.newValue = this.newValue * num10 + number;
		} else {
